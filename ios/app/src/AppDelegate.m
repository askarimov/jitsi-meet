...
//    builder.serverURL = [NSURL URLWithString:@"https://vb1-kt-kzo.bilimland.kz:8443"];
...
//    builder.currentLocale = @"kk";
    [builder setFeatureFlag:@"current.locale" withValue:@"en"];
    // Apple rejected our app because they claim requiring a
    // Dropbox account for recording is not acceptable.
#if DEBUG
    [builder setFeatureFlag:@"ios.recording.enabled" withBoolean:YES];
    [builder setFeatureFlag:@"video-mute.enabled" withBoolean:NO];
#endif
  }];
